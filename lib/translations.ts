...
export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle: "Private door-to-door shuttles + small-group La Fortuna tours. 5★ on Google (190+ reviews) · Book online in 2 minutes · Taxes included.",
    ...
    quote: {
      ...
      allPricesIncludeTaxes: "All prices shown include taxes",
  ...
  es: {
    ...
    hero: {
      ...
      subtitle: "Shuttles privados puerta a puerta + tours grupales en La Fortuna. 5★ en Google (190+ reseñas) · Reservá en 2 minutos · IVA incluido.",
    ...
    quote: {
      ...
      allPricesIncludeTaxes: "Todos los precios incluyen impuestos",
