        ...
        <div className="relative z-10 container mx-auto px-4 pt-24 pb-6 md:pt-24 md:pb-8">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <motion.div
              ...
              className="buscador-claro bg-gradient-to-br from-gray-900/95 to-black/95 border border-amber-500/20 rounded-3xl p-6 md:p-8 shadow-2xl shadow-black/50 overflow-visible"
            >
