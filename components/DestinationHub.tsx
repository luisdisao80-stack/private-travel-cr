    ...
    <main className="min-h-screen bg-slate-50 pt-24 pb-16">
      ...
      <div className="max-w-5xl mx-auto px-4">
        <nav className="text-sm text-slate-500 mb-6">
          ...
          {" / "}
          <Link href="/routes" className="hover:text-orange-600">Routes</Link>
          {" / "}
          <span className="text-slate-600">Shuttle to {destination.name}</span>
        </nav>
        ...
        <section className="mb-10">
          ...
          <p className="text-xl text-slate-600 mb-6 max-w-3xl">{destination.tagline}</p>
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {destination.highlights.map((h, i) => (
              <div key={i} className="flex items-start gap-2 text-slate-600">
                <Check size={18} className="text-orange-600 mt-0.5 flex-shrink-0" />
                <span>{h}</span>
              </div>
            ))}
          </div>
        ...
        {linkedRoutes.length > 0 ? (
          <section className="mb-12" aria-labelledby="hub-routes-heading">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 id="hub-routes-heading" className="text-2xl font-bold text-blue-900">
        ...
        {reviews.length > 0 ? (
          <section className="mb-12" aria-labelledby="hub-reviews-heading">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 id="hub-reviews-heading" className="text-2xl font-bold text-blue-900">
                {placeSpecific
        ...
        <section className="mb-12" aria-labelledby="hub-faq-heading">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 id="hub-faq-heading" className="text-2xl font-bold text-blue-900">
