            ...
            <div className="space-y-6">
              {posts.map((post) => (
                <Link
                  key={post.slug}
                  href={`/blog/${post.slug}`}
                  className="group block bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-orange-300 transition-all duration-300"
                >
                  <div className="flex flex-col md:flex-row gap-6 p-6">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-3 mb-3">
                        <span className="text-xs text-orange-600 bg-orange-50 px-2 py-1 rounded uppercase tracking-wider font-medium">
                          {post.category}
                        </span>
                      ...
                      <h2 className="text-xl md:text-2xl font-bold text-blue-900 mb-2 group-hover:text-orange-600 transition-colors">
                        {post.title}
                      </h2>
