      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <section className="bg-gradient-to-br from-amber-500/10 to-amber-500/5 border border-amber-500/30 rounded-2xl p-6 md:p-8 mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link href={`/book?from=${encodeURIComponent(route.origen)}&to=${encodeURIComponent(route.destino)}`} className="flex-1 bg-amber-500 hover:bg-amber-600 text-black font-bold py-3 px-6 rounded-xl text-center transition">Book Now</Link>
        ...
        <section className="bg-gradient-to-br from-amber-500/20 to-amber-500/10 border border-amber-500/40 rounded-2xl p-8 text-center">
          ...
          <Link href={`/book?from=${encodeURIComponent(route.origen)}&to=${encodeURIComponent(route.destino)}`} className="inline-block bg-amber-500 hover:bg-amber-600 text-black font-bold py-3 px-8 rounded-xl transition">Book Now</Link>
        </section>
      </div>
    </main>
  );
