...
import { Users, Wifi, Droplet, Snowflake, Package, Check, ArrowRight, Mountain, Shield, Star } from "lucide-react";
          ...
          <div className="relative z-10 max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-400 max-w-2xl mx-auto">
                {lang === "en"
                  ? "Premium vehicles for groups of 1 to 9 passengers. Air-conditioned, comfortable, and always driven by professional bilingual drivers."
                  : "Vehículos premium para grupos de 1 a 9 pasajeros. Aire acondicionado, cómodos y siempre con choferes profesionales bilingües."}
              </p>
            </motion.div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black border border-amber-500/20 rounded-2xl overflow-hidden">
              <div className="grid grid-cols-3 text-sm">
                ...
                {/* Filas */}
                {[
                  { label: lang === "en" ? "Passengers" : "Pasajeros", staria: "1-5", hiace: "6-9" },
                  { label: lang === "en" ? "Vehicle type" : "Tipo de vehículo", staria: "SUV", hiace: "Van" },
                  { label: lang === "en" ? "Air conditioning" : "Aire acondicionado", staria: "Premium", hiace: "Dual" },
                  { label: lang === "en" ? "Luggage capacity" : "Capacidad de equipaje", staria: lang === "en" ? "Large" : "Grande", hiace: lang === "en" ? "Extra large" : "Extra grande" },
                  { label: lang === "en" ? "Best for" : "Mejor para", staria: lang === "en" ? "Couples, families" : "Parejas, familias", hiace: lang === "en" ? "Large groups" : "Grupos grandes" },
                  { label: lang === "en" ? "Starting price" : "Precio desde", staria: "$90", hiace: "$117" },
                ].map((row, i) => (
