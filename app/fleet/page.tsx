    ...
    <>
      ...
      <main className="min-h-screen bg-slate-50">
        ...
        <section className="py-16 px-4 border-t border-slate-200">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              {/* Info */}
              <div>
                <div className="text-orange-600 text-xs tracking-widest font-medium mb-2">
                  PREMIUM SUV
                </div>
                <h2 className="text-4xl font-bold text-blue-900 mb-4">Hyundai Staria</h2>

                <div className="flex items-center gap-2 mb-6">
                  <Users size={18} className="text-orange-600" />
                  <span className="text-slate-900 font-medium">1 - 5 {lang === "en" ? "passengers" : "pasajeros"}</span>
                </div>
                ...
                {/* Specs */}
                <div className="grid grid-cols-2 gap-3 mb-6 py-4 border-y border-slate-200">
                  <div className="flex items-center gap-2 text-slate-600 text-sm">
                    <Snowflake size={16} className="text-orange-600" />
                ...
                {/* Tech specs */}
                <div className="bg-orange-50 border border-slate-200 rounded-xl p-4 mb-6">
                  <h4 className="text-slate-900 font-semibold mb-3 text-sm">
                    {lang === "en" ? "Technical specifications" : "Especificaciones técnicas"}
                  </h4>
                  <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-slate-500">{lang === "en" ? "Year:" : "Año:"}</span>
                      <span className="text-slate-600">2025</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-500">{lang === "en" ? "Type:" : "Tipo:"}</span>
                      <span className="text-slate-600">SUV</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-500">{lang === "en" ? "Seats:" : "Asientos:"}</span>
                      <span className="text-slate-600">5 + {lang === "en" ? "driver" : "chofer"}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-500">{lang === "en" ? "Luggage:" : "Equipaje:"}</span>
                      <span className="text-slate-600">5 {lang === "en" ? "large" : "grandes"}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div>
                    ...
                    <div className="text-3xl font-bold text-blue-900">
                      $90 <span className="text-sm text-slate-500 font-normal">USD</span>
                    </div>
                  </div>

                  <Link href="/book">
                    <Button className="bg-orange-600 hover:bg-orange-700 text-white font-bold h-12 px-6">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="lg:order-2">
                ...
                <h2 className="text-4xl font-bold text-blue-900 mb-4">Toyota Hiace</h2>

                <div className="flex items-center gap-2 mb-6">
                  <Users size={18} className="text-orange-600" />
                  <span className="text-slate-900 font-medium">6 - 9 {lang === "en" ? "passengers" : "pasajeros"}</span>
                </div>
                ...
                <div className="bg-orange-50 border border-slate-200 rounded-xl p-4 mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      <span className="text-slate-500">{lang === "en" ? "Type:" : "Tipo:"}</span>
                      <span className="text-slate-600">Van</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-500">{lang === "en" ? "Seats:" : "Asientos:"}</span>
                      <span className="text-slate-600">9 + {lang === "en" ? "driver" : "chofer"}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-500">{lang === "en" ? "Luggage:" : "Equipaje:"}</span>
                      <span className="text-slate-600">9 {lang === "en" ? "large" : "grandes"}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div>
                    ...
                    <div className="text-3xl font-bold text-blue-900">
                      $120 <span className="text-sm text-slate-500 font-normal">USD</span>
                    </div>
                  </div>
              ...
              {/* Foto */}
              <div className="relative bg-white rounded-2xl p-6 border border-slate-200 lg:order-1">
                <img
                  src="/hiace.png"
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <div>
                ...
                <h2 className="text-4xl font-bold text-blue-900 mb-4">Maxus V90</h2>

                <div className="flex items-center gap-2 mb-6">
                  <Users size={18} className="text-orange-600" />
                  <span className="text-slate-900 font-medium">10 - 12 {lang === "en" ? "passengers" : "pasajeros"}</span>
                </div>
                ...
                <div className="bg-orange-50 border border-slate-200 rounded-xl p-4 mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      <span className="text-slate-500">{lang === "en" ? "Type:" : "Tipo:"}</span>
                      <span className="text-slate-600">{lang === "en" ? "Executive Van" : "Van Ejecutiva"}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-500">{lang === "en" ? "Seats:" : "Asientos:"}</span>
                      <span className="text-slate-600">12 + {lang === "en" ? "driver" : "chofer"}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-slate-500">{lang === "en" ? "Luggage:" : "Equipaje:"}</span>
                      <span className="text-slate-600">12 {lang === "en" ? "large" : "grandes"}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div>
                    ...
                    <div className="text-3xl font-bold text-blue-900">
                      $180 <span className="text-sm text-slate-500 font-normal">USD</span>
                    </div>
                  </div>
        ...
        <section className="py-10 px-4 border-t border-slate-200">
          <div className="max-w-3xl mx-auto rounded-2xl border border-slate-200 bg-orange-50 p-5 text-center">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
              <div className="grid grid-cols-4 text-sm">
                ...
                <div className="p-4 border-b border-slate-200 text-center">
                  <span className="text-orange-600 font-bold">Staria</span>
                </div>
                <div className="p-4 border-b border-slate-200 text-center">
                  <span className="text-orange-600 font-bold">Hiace</span>
                </div>
                <div className="p-4 border-b border-slate-200 text-center">
                  <span className="text-orange-600 font-bold">Maxus V90</span>
                </div>
                ...
                {[
                  ...
                  <div key={i} className="contents">
                    <div className="p-4 border-b border-slate-200 text-slate-500">{row.label}</div>
                    <div className="p-4 border-b border-slate-200 text-center text-slate-900 font-medium">{row.staria}</div>
                    <div className="p-4 border-b border-slate-200 text-center text-slate-900 font-medium">{row.hiace}</div>
                    <div className="p-4 border-b border-slate-200 text-center text-slate-900 font-medium">{row.maxus}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="py-20 px-4 border-t border-slate-200">
          <div className="max-w-3xl mx-auto text-center">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-orange-50 border border-slate-200 rounded-2xl p-8 md:p-12"
            >
              ...
              <Link href="/book">
                <Button className="bg-orange-600 hover:bg-orange-700 text-white font-bold h-14 px-10 text-lg">
